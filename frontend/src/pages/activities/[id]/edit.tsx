...
export default function EditActivity() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full bg-blue-700 text-gray-200 py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
      >
        Save
      </button>
    </form>
